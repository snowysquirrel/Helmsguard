...
/obj/structure/globe/attack_hand(mob/user)
	...
	var/mob/living/carbon/human/H = user
	var/random_message = pick("you spin the globe!", "You land on Helmsguard!", "You land on Raneshen!", "You land on port Ice cube!.", "You land on port Thornvale!", "You land on grenzelhoft!")
	to_chat(H, span_notice("[random_message]"))
