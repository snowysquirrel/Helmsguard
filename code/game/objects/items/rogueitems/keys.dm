...
/obj/item/roguekey/lord/proc/anti_stall()
	src.visible_message(span_warning("The Key of Sundmark crumbles to dust, the ashes spiriting away in the direction of the Keep."))
...
/obj/item/roguekey/hand
	name = "hand's key"
	desc = "This regal key belongs to the Lord Castellan's Right Hand."
	icon_state = "cheesekey"
	lockid = "hand"
