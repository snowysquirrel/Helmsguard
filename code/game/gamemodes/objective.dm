...
/datum/objective/marry
	name = "marry"
	explanation_text = "Secure a marriage with the local lord - or alternatively marry one of the royal heirs and ensure they are coronated by the week's end."
	team_explanation_text = "Secure a marriage with the local lord - or alternatively marry one of the royal heirs and ensure they are coronated by the week's end."
