/datum/patron/old_god
	...
	desc = "The true God of everything, Psydon is maximally good - He created human in his image to live in Psydonia, and defended the Helmsguard Basin by sending the COMET SYON to defeat the rampaging archdemon."
