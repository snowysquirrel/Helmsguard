...
/obj/item/clothing/cloak/stabard/surcoat/marshall
	color = "#641E16"
...
/obj/item/clothing/cloak/half/shadowcloak
	name = "stalker cloak"
	desc = "A heavy leather cloak held together by a gilded pin, depicting the Lord Elector's house. The sign of a faithful servant."
