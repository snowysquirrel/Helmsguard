...
/datum/outfit/job/roguetown/confessor/pre_equip(mob/living/carbon/human/H)
	...
	backpack_contents = list(/obj/item/storage/keyring/sund/sund_inquisitor = 1, /obj/item/lockpickring/mundane = 1, /obj/item/rogueweapon/huntingknife/idagger/silver/psydagger, /obj/item/grapplinghook = 1)
