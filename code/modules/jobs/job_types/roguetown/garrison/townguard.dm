...
//	title = "Watchman"
	...
	tutorial = "Responsible for the safety of the town and the enforcement of the Lord Elector's law, you are the vanguard of the city faced with punishing those who defy his Royal Majesty. Though you've many lords to obey, as both the Church and the Marshall have great sway over your life."
