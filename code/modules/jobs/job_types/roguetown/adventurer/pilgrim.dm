/datum/job/roguetown/pilgrim
	...
	tutorial = "Fleeing misfortune you head your way towards Helmsguard, you're not a soldier or an explorer, but a humble migrant trying to look for a better life, if you get to survive the trip that is."
