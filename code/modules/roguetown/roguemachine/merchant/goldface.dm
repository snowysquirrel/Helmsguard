...
/obj/structure/roguemachine/goldface/public/examine()
	...
	. += "<span class='info'>An agreement between the Helmsguardian Guild of Crafts and the Merchant's Guild mandates 100% extra profits on certain protected categories such as gems and steel gears when automated. And 50% on potions.</span>"
