...
/*	emote_see = list("floats hauntingly","weeps mourningly", "laments vengefully")*/
	...
	loot = list(/obj/effect/particle_effect/smoke/transparent)
	minbodytemp = 0
	faction = list("undead")
	footstep_type = null
...
/mob/living/simple_animal/hostile/rogue/ghost/cursed/Initialize()
	. = ..()
	icon_state = "cursed[rand(1, 2)]"

/mob/living/simple_animal/hostile/rogue/ghost/cursed/attacked_by(obj/item/I, mob/living/user)
