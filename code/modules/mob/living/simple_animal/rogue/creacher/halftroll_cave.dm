/mob/living/simple_animal/hostile/retaliate/rogue/halftroll_cave
	icon = 'icons/roguetown/mob/monster/Trolls.dmi'
	name = "half cave troll"
	...
	butcher_results = list(/obj/item/reagent_containers/food/snacks/rogue/meat/steak = 15,
						/obj/item/natural/hide = 15, /obj/item/natural/bundle/bone/full = 3, /obj/item/natural/cavetroll_head = 1)
	faction = list("trolls")
...
/mob/living/simple_animal/hostile/retaliate/rogue/halftroll_cave/death(gibbed)
	..()
	update_icon()

/mob/living/simple_animal/hostile/retaliate/rogue/halftroll_cave/taunted(mob/user)
	emote("aggro")
	Retaliate()
	GiveTarget(user)
	return

/mob/living/simple_animal/hostile/retaliate/rogue/halftroll_cave/Life()
	..()
	if(pulledby)
		Retaliate()
		GiveTarget(pulledby)

/mob/living/simple_animal/hostile/retaliate/rogue/halftroll_cave/get_sound(input)
	switch(input)
		if("aggro")
...
/mob/living/simple_animal/hostile/retaliate/rogue/halftroll_cave/simple_limb_hit(zone)
	if(!zone)
		return ""
	switch(zone)
