...
/datum/objective/vampirelord/infiltrate/one/check_completion()
	var/list/churchjobs = list("Priest", "Priestess", "Cleric", "Monk", "Knight Templar", "Churchling", "Crusader", "Inquisitor")
	for(var/datum/mind/V in SSmapping.retainer.vampires)
...
/datum/objective/vampirelord/infiltrate/two/check_completion()
	var/list/noblejobs = list("Lord Elector", "Lord Consort", "Prince", "Princess", "Hand", "Steward")
	for(var/datum/mind/V in SSmapping.retainer.vampires)
