/datum/language/kazengunese
	name = "Kazengunese"
	desc = "The language of the islands of Kazengun. With intricate honorifics and complex grammar. The version spoken commonly in Sundmark is a result of centuries of cultural contact between the Kazengunese and Zhongese, and is a trade language combining Zhongese & Kazengunese vocabulary"
	speech_verb = "says"
